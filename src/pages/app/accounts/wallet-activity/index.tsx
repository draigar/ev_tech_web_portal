...
import LineChart from 'web/components/ui/charts/lineChart';
import { DefaultLayout } from 'web/layouts'

export default function WalletActivity() {

    const data = [150000, 250000, 450000, 450000, 450000, 650000, 150000, 250000, 450000, 350000, 550000, 250000];
    const labels = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];

    return (
        <DefaultLayout title="Wallet Activity">
                ...
                <div className='page-content'>
                    <div className="container-fluid">
                        <div className="row">
                            <div className="col">
                                <div className="h-100">
                                    <GreetingText description="View all wallet activities" />
                                    <div className="row">
                                        <div className="col-xl-12">
                                            <div className="card">
                                                <div className="card-header">
                                                    <h4 className="card-title mb-0">Wallet Chart Activity</h4>
                                                </div>
                                        ...
                                        <div className="col-lg-12">
                                            <div className="card">
                                                <div className="card-header">
                                                    <h5 className="card-title mb-0">All Wallets Activity</h5>
                                                </div>
                                                    ...
                                                    <table id="example" className="table table-bordered dt-responsive nowrap table-striped align-middle" style={{ width: '100%' }}>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>Joseph Parker</td>
                                                                <td>03 Oct, 2021</td>
                                                                <td><span className="badge badge-soft-info">Re-open</span></td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>Mary Rucker</td>
                                                                <td>05 Oct, 2021</td>
                                                                <td><span className="badge badge-soft-secondary">On-Hold</span></td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>Tonya Noble</td>
                                                                <td>27 April, 2022</td>
                                                                <td><span className="badge badge-soft-danger">Closed</span></td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>James Morris</td>
                                                                <td>12 March, 2022</td>
                                                                <td><span className="badge badge-soft-primary">Open</span></td>
                                                                <td><span className="badge bg-danger">High</span></td>
                                                                <td>
                                                                    <div className="dropdown d-inline-block">
                                                                        <button className="btn btn-soft-secondary btn-sm dropdown" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>Grace Coles</td>
                                                                <td>07 Jan, 2022</td>
                                                                <td><span className="badge badge-soft-success">New</span></td>
                                                                <td><span className="badge bg-danger">High</span></td>
                                                                <td>
                                                                    <div className="dropdown d-inline-block">
                                                                        <button className="btn btn-soft-secondary btn-sm dropdown" type="button" data-bs-toggle="dropdown" aria-expanded="false">
