                                                ...
                                                <div className="card-body">
                                                    ...
                                                    <div className="row">
                                                        ...
                                                        <div className="col-auto mt-4">
                                                            <button className="btn btn-primary" type="button" disabled={CreateAuth.isLoading} onClick={() => DoCreateAdmin()}> {CreateAuth.isLoading ? 'Sending to server...' : 'Create Battery'}</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
