!function() {
    ...
    function v() {
        ...
        !t || "twocolumn" != e && "twocolumn" != t["data-layout"] || (document.querySelector(".navbar-menu") && (document.querySelector(".navbar-menu").innerHTML = u),
        ...
        e && Array.from(e).forEach(function(n) {
            !function e() {
                var t = +n.getAttribute("data-target")
                  ...
                  , o = t / 250;
                o < 1 && (o = 1),
                a < t ? (n.innerText = (a + o).toFixed(0),
                setTimeout(e, 1)) : n.innerText = s(t),
                s(n.innerText)
            }()
        })
    }
    ...
    function k(e) {
        ...
        document.getElementById("layout-width").style.display = "block",
        document.getElementById("sidebar-visibility").style.display = "none"),
        L()) : "twocolumn" == e ? (document.getElementById("scrollbar").removeAttribute("data-simplebar"),
        document.getElementById("scrollbar").classList.remove("h-100"),
        document.getElementById("theme-settings-offcanvas") && (document.getElementById("sidebar-size").style.display = "none",
        document.getElementById("sidebar-view").style.display = "none",
        document.getElementById("sidebar-color").style.display = "block",
    ...
    function q(e) {
        if (e == e) {
            ...
            default:
                ...
                document.documentElement.setAttribute("data-layout", "vertical"),
                k("vertical"),
                f()) : "horizontal" == sessionStorage.getItem("data-layout") ? (T("data-layout", "horizontal"),
                sessionStorage.setItem("data-layout", "horizontal"),
                document.documentElement.setAttribute("data-layout", "horizontal"),
                k("horizontal")) : "twocolumn" == sessionStorage.getItem("data-layout") ? (T("data-layout", "twocolumn"),
                sessionStorage.setItem("data-layout", "twocolumn"),
                document.documentElement.setAttribute("data-layout", "twocolumn"),
                k("twocolumn")) : "semibox" == sessionStorage.getItem("data-layout") && (T("data-layout", "semibox"),
                sessionStorage.setItem("data-layout", "semibox"),
                document.documentElement.setAttribute("data-layout", "semibox"),
                k("semibox"))
            }
            ...
            default:
                ...
                document.documentElement.setAttribute("data-layout-mode", "dark"),
                T("data-layout-mode", "dark")) : (sessionStorage.setItem("data-layout-mode", "light"),
                document.documentElement.setAttribute("data-layout-mode", "light"),
                T("data-layout-mode", "light"))
            }
    ...
    function T(a, e) {
        Array.from(document.querySelectorAll("input[name=" + a + "]")).forEach(function(t) {
            ...
            t.addEventListener("change", function() {
                ...
                sessionStorage.setItem("data-sidebar-size", "sm-hover"),
                document.getElementById("sidebar-size-small-hover").checked = !0) : "data-layout-width" == a && "fluid" == t.value && (document.documentElement.setAttribute("data-sidebar-size", "lg"),
                sessionStorage.setItem("data-sidebar-size", "lg"),
                document.getElementById("sidebar-size-default").checked = !0),
                "data-layout" == a && ("vertical" == t.value ? (k("vertical"),
                f(),
                feather.replace()) : "horizontal" == t.value ? (document.getElementById("sidebarimg-none") && document.getElementById("sidebarimg-none").click(),
                k("horizontal"),
                feather.replace()) : "twocolumn" == t.value ? (k("twocolumn"),
                document.documentElement.setAttribute("data-layout-width", "fluid"),
                document.getElementById("layout-width-fluid").click(),
                v(),
                A(),
                f(),
                feather.replace()) : "semibox" == t.value && (k("semibox"),
                document.documentElement.setAttribute("data-layout-width", "fluid"),
                document.getElementById("layout-width-fluid").click(),
                document.documentElement.setAttribute("data-layout-style", "default"),
                ...
                f(),
                feather.replace())),
                "data-preloader" == a && "enable" == t.value ? (document.documentElement.setAttribute("data-preloader", "enable"),
                (e = document.getElementById("preloader")) && setTimeout(function() {
                    e.style.opacity = "0",
                    e.style.visibility = "hidden"
                }, 1e3),
                document.getElementById("customizerclose-btn").click()) : "data-preloader" == a && "disable" == t.value && (document.documentElement.setAttribute("data-preloader", "disable"),
    ...
    q(a)) : (i = document.documentElement.attributes,
    a = {},
    ...
    (d = document.getElementById("search-options")) && (d.addEventListener("focus", function() {
        ...
        o.classList.remove("d-none")) : (s.classList.remove("show"),
    ...
    t && n && e && (e.addEventListener("focus", function() {
        0 < e.value.length ? (n.classList.add("show"),
        t.classList.remove("d-none")) : (n.classList.remove("show"),
    ...
    D(),
    S(),
    document.getElementsByClassName("dropdown-item-cart") && (r = document.querySelectorAll(".dropdown-item-cart").length,
    ...
    Array.from(m).forEach(function(e) {
        var t, a, o;
        "flatpickr" == e.getAttribute("data-provider") ? (o = e.attributes,
        (t = {}).disableMobile = "true",
        o["data-date-format"] && (t.dateFormat = o["data-date-format"].value.toString()),
        o["data-enable-time"] && (t.enableTime = !0,
        t.dateFormat = o["data-date-format"].value.toString() + " H:i"),
        o["data-altFormat"] && (t.altInput = !0,
        t.altFormat = o["data-altFormat"].value.toString()),
        o["data-minDate"] && (t.minDate = o["data-minDate"].value.toString(),
        t.dateFormat = o["data-date-format"].value.toString()),
        o["data-maxDate"] && (t.maxDate = o["data-maxDate"].value.toString(),
        t.dateFormat = o["data-date-format"].value.toString()),
        o["data-deafult-date"] && (t.defaultDate = o["data-deafult-date"].value.toString(),
        t.dateFormat = o["data-date-format"].value.toString()),
        o["data-multiple-date"] && (t.mode = "multiple",
        t.dateFormat = o["data-date-format"].value.toString()),
        o["data-range-date"] && (t.mode = "range",
        t.dateFormat = o["data-date-format"].value.toString()),
        o["data-inline-date"] && (t.inline = !0,
        t.defaultDate = o["data-deafult-date"].value.toString(),
        t.dateFormat = o["data-date-format"].value.toString()),
        o["data-disable-date"] && ((a = []).push(o["data-disable-date"].value),
        t.disable = a.toString().split(",")),
        o["data-week-number"] && ((a = []).push(o["data-week-number"].value),
        t.weekNumbers = !0),
        flatpickr(e, t)) : "timepickr" == e.getAttribute("data-provider") && (a = {},
        (o = e.attributes)["data-time-basic"] && (a.enableTime = !0,
        a.noCalendar = !0,
        a.dateFormat = "H:i"),
        o["data-time-hrs"] && (a.enableTime = !0,
        a.noCalendar = !0,
        a.dateFormat = "H:i",
        a.time_24hr = !0),
        o["data-min-time"] && (a.enableTime = !0,
        a.noCalendar = !0,
        a.dateFormat = "H:i",
        a.minTime = o["data-min-time"].value.toString()),
        o["data-max-time"] && (a.enableTime = !0,
        a.noCalendar = !0,
        a.dateFormat = "H:i",
        a.minTime = o["data-max-time"].value.toString()),
        o["data-default-time"] && (a.enableTime = !0,
        a.noCalendar = !0,
        a.dateFormat = "H:i",
        a.defaultDate = o["data-default-time"].value.toString()),
        o["data-time-inline"] && (a.enableTime = !0,
        a.noCalendar = !0,
